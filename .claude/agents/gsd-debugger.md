...
<required_reading>
@/home/user/Appointment-tool/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/Appointment-tool/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/Appointment-tool/.claude
                  → checks /home/user/Appointment-tool/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/Appointment-tool/.claude/get-shit-done
                  → writes to /home/user/Appointment-tool/.claude/get-shit-done/hooks/
...
@/home/user/Appointment-tool/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/Appointment-tool/.claude/get-shit-done/references/common-bug-patterns.md
