...
Reference full template: `/home/user/Appointment-tool/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Appointment-tool/.claude/get-shit-done/templates/state.md`.
