...
<reference>
@/home/user/Appointment-tool/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/Appointment-tool/.claude/get-shit-done/references/user-profiling.md` to load:
