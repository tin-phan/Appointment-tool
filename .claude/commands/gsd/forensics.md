...
<execution_context>
@/home/user/Appointment-tool/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/home/user/Appointment-tool/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
