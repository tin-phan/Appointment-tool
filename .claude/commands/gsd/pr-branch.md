...
<execution_context>
@/home/user/Appointment-tool/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @/home/user/Appointment-tool/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
