...
<execution_context>
@/home/user/Appointment-tool/.claude/get-shit-done/workflows/scan.md
</execution_context>

<process>
Execute the scan workflow from @/home/user/Appointment-tool/.claude/get-shit-done/workflows/scan.md end-to-end.
</process>
