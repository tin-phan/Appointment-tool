...
```bash
node "/home/user/Appointment-tool/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/home/user/Appointment-tool/.claude/get-shit-done/templates/retrospective.md`.
