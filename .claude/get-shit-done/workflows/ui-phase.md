...
```markdown
Read /home/user/Appointment-tool/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/Appointment-tool/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/Appointment-tool/.claude/agents/gsd-ui-checker.md for instructions.
