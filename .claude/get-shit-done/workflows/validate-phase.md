...
```
Task(
  prompt="Read /home/user/Appointment-tool/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Appointment-tool/.claude/get-shit-done/templates/VALIDATION.md`
